...
typedef struct
{
	...
	HAL_GPIO_RegDef_t *pGPIOx;		/*< this hold  the base address of the GPIO peripheral >*/
	GPIO_PinCfg_t GPIO_PinConfig;					/*< this hold  GPIO pin configuration >*/
